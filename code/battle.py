...
class Battle:
    ...
    def draw_switch(self):
        ...
        self.available_monsters = {index: monster for index, monster in self.monster_data['player'].items() if (index, monster) in active_monsters and monster.health > 0}
