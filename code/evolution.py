...
class Evolution:
    def __init__(self, frames, start_monster, end_monster, font, end_evolution, start_animation_frames):
        ...
        # star animation
        self.star_frames = [pygame.transform.scale2x(frame) for frame in start_animation_frames]
        self.frame_index = 0
    ...
    def update(self, dt):
        ...
        if not self.timers['start'].active:
            ...
            if self.tint_amount < 255:
                 ...
                 pygame.draw.rect(self.display_surface, COLORS['white'], text_rect.inflate(20, 20))
